...
const LAZY_ENV = () => {
  ...
  const {
    envAsBoolean,
    envAsString
  } = /*@__PURE__*/require$1('../external/@socketsecurity/registry/lib/env');
  const {
  ...
  return Object.freeze({
    ...
    INLINED_SOCKET_CLI_CYCLONEDX_CDXGEN_VERSION: envAsString("11.4.4"),
    ...
    INLINED_SOCKET_CLI_VERSION_HASH: envAsString("1.0.87:848284c:7a0e7ce9:pub"),
...
const lazyNpmCachePath = () => {
  const {
    spawnSync
  } = /*@__PURE__*/require$1('../external/@socketsecurity/registry/lib/spawn');
  return spawnSync(
...
//# debugId=41c776bb-7fe5-4d12-af18-1074a2ee8edd
